...
- 当前工程里的依赖源是 Voxt 维护的镜像 fork `hehehai/mlx-audio-swift`，目前固定在 commit `c96fe7b8577fb1db5a9987a6582e706acb388a8e`。依赖策略见 [docs/MLXAudioDependency.md](./MLXAudioDependency.md)。
