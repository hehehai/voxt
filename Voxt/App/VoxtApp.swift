...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    override init() {
        ...
        UserDefaults.standard.register(defaults: [
            ...
            AppPreferenceKey.meetingServerVADMode: MeetingServerVADMode.automatic.rawValue,
            AppPreferenceKey.meetingSpeakerDiarizationSensitivity: MeetingSpeakerDiarizationSensitivity.balanced.rawValue,
            AppPreferenceKey.meetingSpeakerDiarizationDebugEnabled: false,
