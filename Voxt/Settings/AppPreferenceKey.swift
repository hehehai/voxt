...
enum AppPreferenceKey {
    ...
    static let meetingServerVADMode = "meetingServerVADMode"
    static let meetingSpeakerDiarizationSensitivity = "meetingSpeakerDiarizationSensitivity"
    static let meetingSpeakerDiarizationDebugEnabled = "meetingSpeakerDiarizationDebugEnabled"
