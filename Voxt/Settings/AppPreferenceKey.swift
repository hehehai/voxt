enum AppPreferenceKey {
    ...
    static let meetingEnableSpeakerDiarization = "meetingEnableSpeakerDiarization"
    static let meetingDiarizationVariant = "meetingDiarizationVariant"
    static let meetingEchoMitigationEnabled = "meetingEchoMitigationEnabled"
