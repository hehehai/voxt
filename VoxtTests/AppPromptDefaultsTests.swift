...
final class AppPromptDefaultsTests: XCTestCase {
    ...
    func testEnhancementDefaultPromptIncludesCleanupGuardrails() {
        ...
        XCTAssertContains(englishPrompt, "Preserve the original content order and paragraph structure")
        XCTAssertContains(englishPrompt, "Do not turn continuous prose into headings, lists")
        ...
        XCTAssertContains(japanesePrompt, "混在言語構造")
        XCTAssertContains(japanesePrompt, "原文の内容順序と段落構造")
        XCTAssertContains(japanesePrompt, "連続した文章を見出し、リスト")
